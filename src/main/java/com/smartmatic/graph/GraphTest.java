...
public class GraphTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter any character to start inserting tallies...");

		Scanner scanner = new Scanner(System.in);
		String command = scanner.next();
		while(command.compareToIgnoreCase("q")!=0) {
			try (Transaction tx = obj.graphDb.beginTx()) {
				
				System.out.println("Inserting tally with the following info:"+ Arrays.deepToString(matrix[index]));
